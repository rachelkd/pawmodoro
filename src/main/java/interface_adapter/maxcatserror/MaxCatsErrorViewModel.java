...
public class MaxCatsErrorViewModel extends ViewModel<MaxCatsErrorState> {
    public static final String ERROR_MESSAGE = "Oh no! You have reached the maximum number of cats! You cannot " +
            "adopt at the moment";
    public static final String RETURN_BUTTON_LABEL = "Return";
    public static final String TITLE_LABEL = "Maximum Cats Reached Error";
